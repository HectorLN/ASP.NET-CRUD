...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="Login">
        ...
        <%-- Seccion del correo --%>
        <div id="correo">
            <telerik:RadLabel ID="lbl_correo" runat="server" AssociatedControlID="lbl_correo">
                Correo:
            </telerik:RadLabel>
            <%-- Textbox del correo --%>
            <telerik:RadTextBox ID="txt_correo" runat="server" Mask="Regex" EmptyMessage="Ingrese correo"></telerik:RadTextBox>
            ...
            <asp:RequiredFieldValidator ID="Requiredfieldvalidator1" runat="server" Display="Dynamic"
                ControlToValidate="txt_correo" ErrorMessage="Ingrese un correo valido"></asp:RequiredFieldValidator>
        </div>
